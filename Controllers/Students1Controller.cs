...
namespace MidTerm_Project2.Controllers
{
    public class Students1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,BirthDate,CourseId,CourseEnrolledDate,CourseStatus,Grade")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,BirthDate,CourseId,CourseEnrolledDate,CourseStatus,Grade")] Student student)
        {
            if (ModelState.IsValid)
            {
